...
```
# Output Waveform
![433964730-5006d056-acde-4554-9bd5-c6020748f57c](https://github.com/user-attachments/assets/d180e7d5-940d-46ae-be9e-be6d1ba1c995)
# Results
Phase-shift keying (PSK) will be displayed in separate plots. Thus implemented using python colab.

# Hardware output graph
![440187037-c530b454-156e-4313-a602-cb114af0a861](https://github.com/user-attachments/assets/cfe2befa-abc3-4ff2-a2fa-1a60d3152143)
